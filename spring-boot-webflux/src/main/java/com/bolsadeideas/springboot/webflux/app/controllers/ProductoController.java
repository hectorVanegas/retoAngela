...
public class ProductoController {
	...
	public Flux<Sucursal> sucursals(){
		return service.findAllSucursal();
	}
	...
	public Mono<String> guardar(@Valid Producto producto, BindingResult result, Model model, @RequestPart FilePart file, SessionStatus status){
		...
		Mono<Sucursal> sucursal = service.findSucursalById(producto.getCategoria().getId());
		
		return sucursal.flatMap(c -> {
			...
			log.info("Sucursal asignada: " + p.getCategoria().getNombre() + " Id Cat: " + p.getCategoria().getId());
